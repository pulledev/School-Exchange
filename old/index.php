    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/old/pic/werbung1.png" class="d-block w-100" alt="werbung school exchange">
                <div class="carousel-caption d-none d-md-block">

                </div>
            </div>
            <div class="carousel-item">
                <img src="/old/pic/werbung2.png" class="d-block w-100" alt="werbung school exchange">
                <div class="carousel-caption d-none d-md-block">

                </div>
            </div>
            <div class="carousel-item">
                <img src="/old/pic/werbung3.png" class="d-block w-100" alt="werbung school exchange">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
            <div class="carousel-item">
                <img src="/old/pic/werbung4.png" class="d-block w-100" alt="werbung school exchange">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
        </div>
